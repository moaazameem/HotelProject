...
if(!$conn)
{
  ...
  $sql2="CREATE TABLE bills (
   ...
   $sql = "INSERT INTO bills(fname,lname,phonenum,email,address,dish,quantity,price,grandtotal) VALUES('$fname','$lname','$phonenum','$email','$address','$dish','$quantity','$price','$gtotal')";
  ...
  <?php 
     ...
     ?>
       <div class="container-fluid content">
           ...
           <tr><td class="text-center">Quantity:-<b> <?php echo $row["quantity"] ?>. <br></td></tr>
      ...
      ?>
        <a href="../php/customerpanel.php"><button class="btn btn-default">Home</button><a>
